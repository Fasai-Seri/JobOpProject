...
class JobPost(models.Model):
    ...
    job_address = models.CharField(max_length=1000, null=True)
    job_location_long = models.DecimalField(max_digits=9, decimal_places=6, null=True)
    job_location_lat  = models.DecimalField(max_digits=9, decimal_places=6, null=True)
